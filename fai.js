...
const HF_API_KEY = process.env.HF_API_KEY; // Ensure your API key is set in your environment variables
...
export async function fetchFAI(query) {
  ...
  const answer = result[0]?.generated_text || result.generated_text || JSON.stringify(result);
